...
void hw_setup_adc_channels(void) {
	...
	ADC_RegularChannelConfig(ADC1, ADC_Channel_12, 1, t_samp);
	...
	ADC_RegularChannelConfig(ADC3, ADC_Channel_10, 1, t_samp);
...
//	}
	...
	// Injected channels
	ADC_InjectedChannelConfig(ADC1, ADC_Channel_12, 1, t_samp);
	ADC_InjectedChannelConfig(ADC2, ADC_Channel_11, 1, t_samp);
	ADC_InjectedChannelConfig(ADC3, ADC_Channel_10, 1, t_samp);
	ADC_InjectedChannelConfig(ADC1, ADC_Channel_12, 2, t_samp);
	ADC_InjectedChannelConfig(ADC2, ADC_Channel_11, 2, t_samp);
	ADC_InjectedChannelConfig(ADC3, ADC_Channel_10, 2, t_samp);
	ADC_InjectedChannelConfig(ADC1, ADC_Channel_12, 3, t_samp);
	ADC_InjectedChannelConfig(ADC2, ADC_Channel_11, 3, t_samp);
	ADC_InjectedChannelConfig(ADC3, ADC_Channel_10, 3, t_samp);
}
